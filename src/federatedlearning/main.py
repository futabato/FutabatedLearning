...
from federatedlearning.models.cnn import CNNMnist, CNNCifar
...
if __name__ == '__main__':
    ...
    # define paths
    logger = SummaryWriter('/workspace/logs')
    ...
    file_name = '/workspace/outputs/objects/{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}].pkl'.\
